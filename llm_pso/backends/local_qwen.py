"""Local Qwen2.5-1.5B-Instruct backend running on CPU."""
...
class QwenBackend(BaseLLMBackend):
    ...
    Lazy-loads model on first call to avoid startup cost if never used.
    Runs on CPU to avoid MPS/CUDA contention with training.
    """
